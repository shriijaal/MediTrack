...
export function MedsSlide({ userId, toast, onBack, caretakerPatientId }) {
  ...
  // Refresh helper used after add/edit/delete
  ...
  // Load from backend on mount / when writeId changes
  useEffect(() => {
    let cancelled = false;
  ...
  }, [writeId]); // eslint-disable-line react-hooks/exhaustive-deps
