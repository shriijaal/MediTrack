...
export function ReportsSlide({ userId, onBack }) {
  ...
  const load = async (v, date, year, month) => {
  ...
  useEffect(() => { load(view, curDate, curYear, curMonth); },
    [view, curDate, curYear, curMonth]); // eslint-disable-line react-hooks/exhaustive-deps
