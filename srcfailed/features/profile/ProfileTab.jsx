...
export function ProfileTab({ user, userId, onLogout, onOpenRx, onSwitchPatient, activePatient }) {
        ...
        {isCaretaker && (
          <>
            ...
            {listLoading ? (
              ...
              <div className="ib">
                {patients.map(p => (
                  <div key={p.id} className="ir" style={{ cursor: "pointer" }} onClick={() => { onSwitchPatient(p); setInner(null); }}>
              ...
              <div className="ib">
                {caretakers.map(c => (
                  <div key={c.id} className="ir">
                    <div className="il" style={{ flex: 1 }}>
                      <div className="ii" style={{ background: "#EFF6FF", color: "#3B82F6", fontFamily: "'Syne',sans-serif", fontWeight: 700, fontSize: 16 }}>
  ...
  return (
    <div className="cnt">
      ...
      <div className="ib" style={{ marginBottom: 16 }}>
        ...
        <div className="ir" style={{ cursor: "pointer" }} onClick={openCaretaker}>
          <div className="il" style={{ flex: 1 }}>
            <div className="ii" style={{ background: "#EFF6FF", color: "#3B82F6" }}>
        ...
        {/* Settings row */}
        <div className="ir" style={{ cursor: "pointer" }} onClick={() => setInner("settings")}>
          <div className="il" style={{ flex: 1 }}>
            <div className="ii" style={{ background: "#F5F3FF", color: "#7C3AED" }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="12" cy="12" r="3" />
